...
When I get around to it, I would like to add a emmet-vim script to auto add all these instead of just the standard "en" tag. I haven't found out how to make that change with vscode but if someone knows... It should be added here! :D